    ...
    <body>
      <!--NAVBAR-->
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-dark header" style="height: 80px;">
            <a class="navbar-brand" href="#"><h1>Let's Get Hired</h1></a>
          ...
          <div class="container px-lg-5 mb-5">
            <div class="row mx-lg-n5">
              <div class="col py-3 px-lg-5 mr-2 border">
                ...
                <div class="link">
                <a class="link-decorate" href="https://www.linkedin.com/in/swati-basu-818509168/"><h4>Swati Basu</h4></a>
                </div>
              </div>
              <div class="col py-3 px-lg-5 mr-2 border">
                <img src="images/a4.jpeg"  class="img-fluid contact-image" alt="Responsive image">
                <div class="link">
                  <a class="link-decorate" href="https://www.linkedin.com/in/hritika-verma-96a2a01a5/"><h4>Hritika Verma</h4></a>
                </div>
              </div>
              <div class="col py-3 px-lg-5 mr-2 border">
                <img src="images/a7.jpg"  class="img-fluid contact-image" alt="Responsive image">
                <div class="link">
                  <a class="link-decorate" href="https://www.linkedin.com/in/sangeetha-panicker-339827140"><h4>Sangeetha</h4></a>
                </div>
              </div>
              <div class="col py-3 px-lg-5 border">
                <img src="images/a5.jpg"  class="img-fluid contact-image" alt="Responsive image">
                <div class="link">
                  <a class="link-decorate" href="https://www.linkedin.com/in/sonam-prasad-2b28141b7"><h4>Sonam</h4></a>
                </div>
              </div>
            </div>
          </div>
